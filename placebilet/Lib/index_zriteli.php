...
$libPath =	realpath(__DIR__.'/../src/Lib/');

require_once JPATH_PLATFORM.'/import.php';
require_once $libPath.'/Reg.php';//require_once $libPath.'/registry.php';
...
//toPrint($str_params,'$str_params',1, $viewText, TRUE);
$param = new \Joomla\Plugin\Jshopping\Placebilet\Lib\Reg($str_params);// new \Joomla\Registry\Registry($str_params);
//toPrint($str_params,'$str_params',1, $viewText, TRUE);
...
//			toLog(JPATH_PLUGINS, 'JPATH_PLUGINS');
	$zriteliFile = JPATH_PLUGINS.'/jshopping/placebilet/src/Lib/Zriteli.php';
