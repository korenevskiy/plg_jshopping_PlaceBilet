...
$wa->registerAndUseStyle('placebilet.admin.print', 'plugins/jshopping/placebilet/media/print.css', [], ['media'=>'print']);
...
if(empty(file_exists(PlaceBiletPath . '/ControllerA/StatisticsController.php'))){
?>
<div id="j-main-container"  class="j-main-container page_report">
	<?= JText::_('JSHOP_PLACE_BILET_UPLOAD_STATISTICSBUY')?>
</div>
<?php return;
}
...
//\Joomla\CMS\Factory::$application->enqueueMessage("<pre>fieldDateStart: ".print_r($this->fieldDateStart,true)."</pre>");
//\Joomla\CMS\Factory::$application->enqueueMessage("<pre>fieldDateStop: ".print_r($this->fieldDateStop,true)."</pre>");
