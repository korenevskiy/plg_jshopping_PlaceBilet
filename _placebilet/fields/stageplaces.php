...
//        require_once (JPATH_SITE.DS.'plugins'.DS.'jshopping'.DS.'placebilet'.DS.'Lib'.DS.'SoapClient.php'); 
        ...
        require_once (JPATH_SITE.DS.'plugins/jshopping/placebilet/src/Lib/Zriteli.php'); 
...
//		$this->params = PlaceBiletHelper::$param; // JRegistry::getInstance('PlaceBilet')->loadString($params);
        ...
        $this->params = new Reg($this->plugin->get('params'));//,$plugin->params //$this->plugin->loadString($this->plugin->get('params'));
