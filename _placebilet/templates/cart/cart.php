    ...
    <tr class="jshop_prod_cart <?php if ($i % 2 == 0) print "even"; else print "odd"?>">
        ...
        <td class="remove">
            <div class="data">
                ...
                <?php } else { ?>
<?php
//\Joomla\Component\Jshopping\Site\Helper::SEFLink($cart->getUrlList(),0,1)
...
//print_r($cart->getUrlList());

//echo "<br> | <br>";
////	https://tickets.hc-grad.ru/component/jshopping/cart
////	/cart
//print_r(\Joomla\Component\Jshopping\Site\Helper\Helper::SEFLink($cart->getUrlList(),0));
//echo "<br> | <br>";
//
//print_r(\Joomla\Component\Jshopping\Site\Helper\Helper::SEFLink($cart->getUrlList()));
//echo "<br> | <br>";
//
//print_r(\Joomla\Component\Jshopping\Site\Helper\Helper::getDefaultItemid($cart->getUrlList()));
//
//echo "<br> | <br>";
//
//print_r(JFactory::getApplication()->input->getInt('Itemid'));
?>
				<a class="button-img link-danger _btn-outline-danger btn-lg" href="<?php print $prod['href_delete']?>" onclick="return confirm('<?php print JText::_('JSHOP_CONFIRM_REMOVE')?>')" role-label="<?= JText::_('JSHOP_DELETE')?>">
