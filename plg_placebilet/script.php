...
//		$dirs = array_filter(glob('*'), 'is_dir');
	...
	private $new_tbl_columns = [
		...
		'order_item' => [
			...
			'place_go'		=> 'ALTER TABLE #__jshopping_order_item ADD `place_go`		TEXT NULL COMMENT "[\"sequence number select Place in order item. Порядковый номер выбранного места в этом заказе этго товара\"...] " ; ',
