...
foreach($lists['all_place_attributes'] as $place_attribute){
    $count_i++;
    if($place_attribute->attr_admin_type != 4)
		continue;
...
//echo " </pre>";
   ...
   <a href="index.php?option=com_jshopping&controller=attributes" target="_blank"><img src="components/com_jshopping/images/jshop_attributes_s.png" border='0' align="left" style="margin-right:5px"><?php print __('JSHOP_LIST_ATTRIBUTES');?></a>
</div>
