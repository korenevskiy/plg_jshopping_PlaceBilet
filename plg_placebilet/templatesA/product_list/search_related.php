...
<div class="block_related" id="serched_product_<?php print $row->product_id;?>">
    <div class="block_related_inner">
        ...
        <div style="padding-top:5px;"><input type="button" class="btn btn-small btn-success" value="<?php print __('JSHOP_ADD');?>" onclick="add_to_list_relatad(<?php print $row->product_id;?>)"></div>
    </div>
</div>
<?php
}
