...
<div class="js-stools clearfix jshop_block_filter">
    ...
    <div class="js-stools-container-bar">
        <div class="filter-search btn-group pull-left">
            <input type="text" id="text_search" name="text_search" placeholder="<?php print __('JSHOP_SEARCH')?>" value="<?php echo htmlspecialchars($text_search);?>" />
        </div>

        <div class="btn-group pull-left hidden-phone">
            <button class="btn hasTooltip" type="submit" title="<?php print __('JSHOP_SEARCH')?>">
                <i class="icon-search"></i>
            </button>
            <button class="btn hasTooltip" onclick="document.id('text_search').value='';this.form.submit();" type="button" title="<?php print __('JSHOP_CLEAR')?>">
    ...
    <div class="js-stools-container-filters">
        ...
        <?php if ($this->config->admin_show_product_labels ?? FALSE){?>
            <div class="js-stools-field-filter">
...
<thead> 
  <tr>
	...
	<th width="93">
		<?php print __('JSHOP_IMAGE'); ?>
	</th>
	<th>
	  <?php echo __('JSHOP_TITLE'); ?>
	</th>
    <?php print $this->tmp_html_col_after_title ?? ''?>
	<?php if (!$category_id){?>
	<th width="80">
	  <?php echo __('JSHOP_CATEGORY');?>
	</th>
	<?php }?>
	<?php if (!$manufacturer_id){?>
	<th width="80">
	  <?php echo __('JSHOP_MANUFACTURER');?>
	</th>
	<?php }?>
	<th width="60">
		<?php echo __('JSHOP_PRICE');?>
	</th>
	<th width="60">
		<?php echo __('JSHOP_DATE');?>
	</th>
	<th width="40" class="center">
	  <?php echo __('JSHOP_PUBLISH');?>
	</th>
	<th width="30" class="center">
	  <?php echo __('JSHOP_ID');?>
	</th>
  </tr>
</thead> 
