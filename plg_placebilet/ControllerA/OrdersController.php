...
class OrdersModController extends OrdersController{
...
//        $order_items = $order->getAllItems();
        ...
        //\JFactory::getApplication()->triggerEvent('onAfterQueryGetAttributes2', array(&$query)); 

        //echo sprintf(__('JSHOP_ORDER_DELETE_ATRIBUTE'), $order_number)."<!-- <br/> Удалено ".$row_delete."--><br/>";//.($result?" Удалено ".$db->getAffectedRows():" Не удалено <br/>".__LINE__." ".$db->stderr()) ; 
...
//        $_list_status0[] = JHTML::_('select.option', 0, __('JSHOP_ALL_ORDERS'), 'status_id', 'name');
...
//        $nf_option = array();
//        $nf_option[] = JHTML::_('select.option', 0, __('JSHOP_HIDE'), 'id', 'name');
//        $nf_option[] = JHTML::_('select.option', 1, __('JSHOP_SHOW'), 'id', 'name');
...
//
//    function printOrder(){
//        \PlaceBiletHelper::JInput()->set("print", 1);
//        $this->show();
//    }
//    
...
//        $this->_updateStatus(\PlaceBiletHelper::JInput()->get('order_id'),\PlaceBiletHelper::JInput()->get('order_status'),\PlaceBiletHelper::JInput()->get('status_id'),\PlaceBiletHelper::JInput()->get('notify',0),\PlaceBiletHelper::JInput()->get('comments',''),\PlaceBiletHelper::JInput()->get('include',''),0);        
//    }    
//    
...
//        
//        if ($view_order){
//            $this->setRedirect("index.php?option=com_jshopping&controller=orders&task=show&order_id=".$order_id, __('JSHOP_ORDER_STATUS_CHANGED'));
//        }else{
//            $this->setRedirect("index.php?option=com_jshopping&controller=orders&client_id=".$client_id, __('JSHOP_ORDER_STATUS_CHANGED'));
//		}
//    }
//    
//    function finish(){
...
//        
//        JSFactory::loadAdminLanguageFile();
//        $this->setRedirect("index.php?option=com_jshopping&controller=orders", __('JSHOP_ORDER_FINISHED'));
//    }
//
//    function remove(){
//        $client_id = \PlaceBiletHelper::JInput('client_id',0);
...
//        
//        $msg = sprintf(__('JSHOP_ORDER_DELETED_ID'), implode(", ", $cid));
...
//        $display_price_list[] = JHTML::_('select.option', 0, __('JSHOP_PRODUCT_BRUTTO_PRICE'), 'id', 'name');
//        $display_price_list[] = JHTML::_('select.option', 1, __('JSHOP_PRODUCT_NETTO_PRICE'), 'id', 'name');
...
//        $checkout->sendOrderEmail($order_id, 1);
//        JSFactory::loadAdminLanguageFile();
//        $this->setRedirect("index.php?option=com_jshopping&controller=orders&task=show&order_id=".$order_id, __('JSHOP_MAIL_HAS_BEEN_SENT'));
//    }
//    
