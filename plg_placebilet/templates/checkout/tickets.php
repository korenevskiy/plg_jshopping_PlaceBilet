...
<div class="ticket_js" style="		display: flex; 
		...
		width: fit-content;
		align-items: center;">
	<img src="cid:<?=$imageAlias ?>" width="210" height="210" alt="<?=$QRcode?>" style="
	...
	<div  style=" padding:10px 10px 3px 10px; max-width: 440px;">
		...
		<h4 class="product" style="margin: 5px 0px 0px; ">
			<?=$product_name?>
		...
		<div class="info"   >
			<dl style="display: grid;
				...
				<?php if($categrois_name): ?>
				<dt style="
						grid-column-start: 1;
						border-top: 1px solid #ccc;">
					<?= count($categrois_name)==1 ? JText::_('JCATEGORY') : JText::_('JCATEGORIES')?>
				</dt>
					<?php foreach ($categrois_name as $cat_name){ ?>
					<dd style="
							grid-column-start: 2;
							margin-inline-start: 0px;
							padding-inline-start: 10px;
