...
?>
				<a class="button-img link-danger _btn-outline-danger btn-lg" href="<?php print $prod['href_delete']?>" onclick="return confirm('<?php print JText::_('JSHOP_CONFIRM_REMOVE')?>')" role-label="<?= __('JSHOP_DELETE')?>">
