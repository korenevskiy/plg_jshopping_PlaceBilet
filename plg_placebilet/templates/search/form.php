...
<div class = "jshop" id="comjshop">
    <h1><?php print __('JSHOP_SEARCH') ?></h1>
    ...
    <form action="<?php print $this->action?>" name="form_ad_search" method="post" onsubmit="return validateFormAdvancedSearch('form_ad_search')" class = "form-horizontal">
        ...
        <div class = "jshop">
            ...
            <div class = "control-group">
                <div class = "control-label">
                    <?php print __('JSHOP_SEARCH_TEXT')?>
                </div>
                <div class = "controls">
            ...
            <div class = "control-group">
                <div class = "control-label">
                  <?php print __('JSHOP_SEARCH_FOR')?>
                </div>
                <div class = "controls">
                    <input type="radio" name="search_type" value="any" id="search_type_any" checked="checked" /> <label for="search_type_any"><?php print __('JSHOP_ANY_WORDS')?></label>
                    <input type="radio" name="search_type" value="all" id="search_type_all" /> <label for="search_type_all"><?php print __('JSHOP_ALL_WORDS')?></label>
                    <input type="radio" name="search_type" value="exact" id="search_type_exact" /> <label for="search_type_exact"><?php print __('JSHOP_EXACT_WORDS')?></label>
                </div>
            </div>
            <div class = "control-group">
                <div class = "control-label">
                    <?php print __('JSHOP_SEARCH_CATEGORIES') ?>
                </div>
                <div class = "controls">
                    <div><?php print $this->list_categories ?></div>
                    <div>
                        <input type = "checkbox" name = "include_subcat" id = "include_subcat" value = "1" />
                        <label for = "include_subcat"><?php print __('JSHOP_SEARCH_INCLUDE_SUBCAT') ?></label>
                    </div>
                </div>
            </div>
            <div class = "control-group">
                <div class = "control-label">
                    <?php print __('JSHOP_SEARCH_MANUFACTURERS') ?>    
                </div>
                <div class = "controls">
            ...
            <div class = "control-group">
                <div class = "control-label">
                    <?php print __('JSHOP_SEARCH_PRICE_FROM') ?>      
                </div>
                <div class = "controls">
            ...
            <div class = "control-group">
                <div class = "control-label">
                    <?php print __('JSHOP_SEARCH_PRICE_TO') ?>      
                </div>
                <div class = "controls">
            ...
            <div class = "control-group">
                <div class = "control-label">
                    <?php print __('JSHOP_SEARCH_DATE_FROM') ?>      
                </div>
                <div class = "controls">
            ...
            <div class = "control-group">
                <div class = "control-label">
                    <?php print __('JSHOP_SEARCH_DATE_TO') ?>      
                </div>
                <div class = "controls">
        ...
        <div class = "control-group">
            <div class = "controls">
                <input type = "submit" class = "btn btn-primary button" value = "<?php print __('JSHOP_SEARCH') ?>" />  
            </div>
        </div>
    </form>
</div>