...
//file_put_contents(__DIR__ . '/logHelper.txt', "$prop => $val \n", FILE_APPEND);
	...
	public function setQR($QRcode = ''){
		...
		if($this->place_pushka && $this->index !== ''){
			$place_pushka	= (array) str_getcsv($this->place_pushka);// 0000721b-be15-4bc2-a80a-f6c047417134,0000721b-b94d-418e-abdf-73a229404396
