...
//    define('DS', DIRECTORY_SEPARATOR);
        require_once (JPATH_SITE.DIRECTORY_SEPARATOR.'plugins'
                .DIRECTORY_SEPARATOR.'jshopping'.DIRECTORY_SEPARATOR.'PlaceBilet'
                .DIRECTORY_SEPARATOR.'Libraries'.DIRECTORY_SEPARATOR.'SoapClient.php');
...
//        toPrint($categories);
        ...
        $html = JHTML::_('select.genericlist', $categories,$this->name,'class="inputbox chzn-custom-value"   ','val','title',$value);
        return $html;
        //toLog($html);
  }
}
