...
<?php print $this->tmp_html_start?>
    <fieldset class="adminform">
        ...
        //$btn_back = "<button onclick=\"Joomla.submitbutton('back')\" class='btn ' style=' float: right;'><i class='icon-arrow-left'></i>".JText::_('_JSHOP_BACK_TO_ATTRIBUTES')."</button>";
        $back = "<span class='back_btn' style='float: right;'> $attr_id </span>";
        echo "<legend  >$this->attr_name $this->group_n $btn_back $back </legend>"; ?>
         
    
        <table class="jssubmenu" style="width: 100%; background: #EBF0F3; border-radius:10px;">
        ...
        <td>
            <figure class="adminform"><legend><?php echo JText::_('JSHOP_ADD_RANGE'); ?></legend>
            ...
            <figure class="adminform"><legend><?php echo JText::_('JSHOP_ADD_STRING') ?> </legend>
            ...
            <figure class="adminform"><legend><?php  echo JText::_('JSHOP_REMOVE_RANGE') ?> </legend>
            ...
            <figure class="adminform"><legend><?php  echo JText::_('JSHOP_REMOVE_STRING') ?></legend>
