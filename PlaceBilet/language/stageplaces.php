...
class JFormFieldStagePlaces extends JFormField {
  ...
  protected function getInput(){
      defined('DS') or define('DS', DIRECTORY_SEPARATOR);
        require_once (JPATH_SITE.DS.'plugins'.DS.'jshopping'.DS.'PlaceBilet'.DS.'Libraries'.DS.'SoapClient.php'); 
        require_once (JPATH_SITE.DS.'plugins'.DS.'jshopping'.DS.'PlaceBilet'.DS.'Libraries'.DS.'Zriteli.php'); 
