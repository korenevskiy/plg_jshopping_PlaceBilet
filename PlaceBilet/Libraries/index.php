...
//teatr-chehova.ru/public_html/plugins/jshopping/PlaceBilet/Libraries/index.php?log=write_data123.txt
...
//			toLog(JPATH_PLUGINS, 'JPATH_PLUGINS');
	$zriteliFile = JPATH_PLUGINS.'/jshopping/PlaceBilet/Libraries/Zriteli.php';
...
list($products_count_exist, $products_count_New, $products_count_onlyDB, $products_NOexist) = $prods;
